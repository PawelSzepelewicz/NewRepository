...
values (1, 1);
insert into USERS(id, username, description, rating, email, password, enabled)
values (2, 'User', 'Client', 2515, 'client@gmail.com', '$2a$12$1rMB6IhSafSiSwIS2zMfJeG.FlUvG5AfbI0AuQ0/3pFlKT0FXuXlG', false);
insert into USER_ROLES(user_id, role_id) values (2,1);
insert into VERIFICATION_TOKEN(id, token, expiry_date)
values (2, '902a8cf0-63a7-444f-a424-8960907e7eee', CAST(CURRENT_TIME AS TIMESTAMP) + INTERVAL '2' HOUR);
insert into USER_TOKEN(user_id, token_id)
values (2, 2);
insert into USERS(id, username, description, rating, email, password, enabled)
